     ...
     public function update(Request $request, $id)
     {
         ...
         if($address_type == 'present'){
             $this->rules = [
                 ...
                 /**removed 'present_postal_code'  => [ 'required','numeric'], */
             ];
             $this->messages = [
         ...
         elseif($address_type == 'permanent'){
             $this->rules = [
                 ...
                 /**removed  'permanent_postal_code'  => [ 'required','numeric'], */
             ];
             $this->messages = [
                 ...
                 // removed 'permanent_postal_code.required' => translate('Postal Code is required'),
                 //removed 'permanent_postal_code.numeric'  => translate('Postal Code should be numeric type'),
         ...
         if($address_type == 'present'){
            ...
            // removed $address->postal_code  = $request->present_postal_code;
         }
         elseif($address_type == 'permanent'){
