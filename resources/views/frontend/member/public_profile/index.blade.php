            ...
            <div class="col-xl-8 offset-xl-4">
                ...
                <div class="mt-4">
                    <div class="nav nav-tabs aiz-nav-tabs bottom-bordered active-white border-0">
                        <a class="text-black-50 d-inline-block fw-600 fs-15 px-3 py-2 active" data-toggle="tab" href="#profile">{{ translate('Detailed Profile') }}</a>
                        @if(get_setting('member_partner_expectation_section') == 'on')
                            <a class="text-black-50 d-inline-block fw-600 fs-15 px-3 py-2" data-toggle="tab" href="#preference">{{ translate('Partner Preference') }}</a>
                        @endif
                        <a class="text-black-50 d-inline-block fw-600 fs-15 px-3 py-2" data-toggle="tab" href="#gallery">{{ translate('Photo Gallery') }}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="aiz-profile-sidebar">
                    ...
                    <div class="mb-4 p-4 border rounded border-gray-200 d-none d-xl-block">
                        ...
                        <div class="row gutters-5">
                            <div class="col">
                                <a href="avascript:void(0);" onclick="ignore_member({{ $user->id }})" class="btn btn-block btn-primary text-left">
                    ...
                    <div class="border rounded">
                        <a href="{{ get_setting('public_profile_page_banner_link') }}" class="text-reset">
                            <img src="{{ uploaded_asset(get_setting('public_profile_page_banner')) }}" class="img-fluid w-100">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-xl-8 offset-xxl-1">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="profile">
                        ...
                        <div class="accordion aiz-timeline-accordion" id="profile-accordion">
                                ...
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <span class="fs-11 fw-400">
                                            ...
                                            <span>{{ translate('On Behalf:')}} {{ $user->member->on_behalves->name }}</span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22.936" height="27.722" viewBox="0 0 22.936 27.722" class="fill-primary-grad">
                                ...
                                <div id="basic-info" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                                ...
                                                <table class="w-100 table-striped">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="py-1">
                                                                @if(!empty($user->member->mothere_tongue))
                                                                {{ optional(\App\Models\MemberLanguage::where('id',$user->member->mothere_tongue)->first())->name }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="py-1 fw-600">{{ translate('No. of  Children') }}
                                                            </td>
                                            ...
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100  table-striped">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600">{{ translate('Marital Status') }}
                                                            </td>
                                                            <td class="py-1">
                                                                {{ !empty($user->member->marital_status->name) ? $user->member->marital_status->name : ""  }}
                                                            </td>
                            ...
                            @php
                            $view_contact = \App\Models\ViewContact::where('user_id',
                            $user->id)->where('viewed_by',Auth::user()->id)->first();
                            @endphp
                            <!-- Contact Details -->
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                ...
                                <div id="contact-details" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3">
                                              @if($user->phone != null)
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div>
                                                        <div class="fs-15 fw-600 mb-1">{{ translate('Contact Number') }}
                                                        </div>
                                                ...
                                                <a onclick="view_contact({{ $user->id }})"
                                                    ...
                                                    <i class="las la-phone"></i> {{ translate('View Contact Info') }}
                                                </a>
                                                <br>
                                                @endif
                                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24.971" height="20.838" viewBox="0 0 24.971 20.838" class="fill-primary-grad">
                                ...
                                <div id="education" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <table class="table aiz-table table-striped">
                                        <tbody>
                                            <tr>
                ...
                <th data-breakpoints="sm">{{translate('Status')}}</th>
                            ...
                            <div class="pb-4 accordion-item">
                                ...
                                <div id="career" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <table class="table aiz-table table-striped">
                                        <tbody>
                                            <tr>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20.998" height="21.121" viewBox="0 0 20.998 21.121" class="fill-primary-grad">
                                            <g transform="translate(-1082.003 -1774.616)">
                                                ...
                                                <path d="M-15510,17.738l.549-.549,2.444,2.444V18.415h0V1.487l-2.44,2.444-.549-.549,3.379-3.383,3.382,3.383-.549.549-2.444-2.444V19.634l2.444-2.444.549.549-3.382,3.383Z" transform="translate(16592 1774.616)" class="fill-dark"/>
                                                <rect width="3" height="21" transform="translate(1100.001 1774.616)" class="fill-dark"/>
                                            </g>
                                        </svg>
                                    </span>
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block">{{ translate('Physical Attributes') }}</span>
                                    </div>
                                </div>
                                <div id="physical-attributes" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 table-striped">
                                                    <tbody>
                                                        <tr>
                                                            <td class="py-1 fw-600">{{ translate('Weight') }}</td>
                                                            <td class="py-1">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="26.953" height="26.953" viewBox="0 0 26.953 26.953" class="fill-primary-grad">
                                            <g transform="translate(0)">
                                                ...
                                                <g transform="translate(8.25 9.002)">
                                                    <path d="M11.241,1.494a.748.748,0,0,1,.747.747V5.228a.747.747,0,0,1-1.494,0V2.241a.748.748,0,0,1,.747-.747Zm0-1.494A2.241,2.241,0,0,0,9,2.241V5.228a2.241,2.241,0,0,0,4.481,0V2.241A2.241,2.241,0,0,0,11.241,0Z" transform="translate(-6.012)" class="fill-dark"/>
                                                    <path d="M13,26h1.494v1.494a.747.747,0,1,1-1.494,0Z" transform="translate(-8.519 -16.291)" class="fill-dark"/>
                                                    <path d="M10.709,8a.747.747,0,0,0-.747.747v1.362a3.822,3.822,0,0,1-3.478,3.858,3.738,3.738,0,0,1-3.99-3.726V8.747A.747.747,0,1,0,1,8.747v1.346a5.325,5.325,0,0,0,4.975,5.37,5.228,5.228,0,0,0,5.481-5.222V8.747A.747.747,0,0,0,10.709,8Z" transform="translate(-0.999 -5.013)" class="fill-dark"/>
                                                </g>
                                            </g>
                                        </svg>
                                    </span>
                                ...
                                <div id="language" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block">{{ translate('Hobbies & Interest') }}</span>
                                    </div>
                                </div>
                                <div id="hobby" class="accordion-body ml-3 ml-md-5 pl-25px"
                                    data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="py-1">{{ !empty($user->hobbies->music) ? $user->hobbies->music : "" }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1">{{translate('Movies')}}</th>
                                                        <td class="py-1">{{ !empty($user->hobbies->movies) ? $user->hobbies->movies : "" }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1">{{translate('Sports')}}</th>
                                                        <td class="py-1">{{ !empty($user->hobbies->sports) ? $user->hobbies->sports : "" }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="py-1">{{translate('Cuisines')}}</th>
                                                        <td class="py-1">{{ !empty($user->hobbies->cuisines) ? $user->hobbies->cuisines : "" }}</td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 table-striped">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1">{{translate('Interests')}}</th>
                                                            <td class="py-1">{{ !empty($user->hobbies->interests) ? $user->hobbies->interests : "" }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Books')}}</th>
                                                            <td class="py-1">{{ !empty($user->hobbies->books) ? $user->hobbies->books : "" }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('TV Shows')}}</th>
                                                            <td class="py-1">{{ !empty($user->hobbies->tv_shows) ? $user->hobbies->tv_shows : "" }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Fitness Activities')}}</th>
                                                            <td class="py-1">{{ !empty($user->hobbies->fitness_activities) ? $user->hobbies->fitness_activities : "" }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Dress Styles')}}</th>
                                                            <td class="py-1">{{ !empty($user->hobbies->dress_styles) ? $user->hobbies->dress_styles : "" }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span class="fs-18 fw-600 d-block">{{ translate('Personal Attitude & Behavior') }}</span>
                                    </div>
                                </div>
                                <div id="personal-attitude" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
                                                    <tbody>
                                                        <tr>
                                                            <th class="py-1">{{translate('Affection')}}</th>
                                                            <td class="py-1">{{ !empty($user->attitude->affection) ? $user->attitude->affection : "" }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Political Views')}}</th>
                                                            <td class="py-1">{{ !empty($user->attitude->political_views) ? $user->attitude->political_views : "" }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="w-100 table-striped">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="py-1">{{ !empty($user->attitude->humor) ? $user->attitude->humor : "" }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Religious Service')}}</th>
                                                            <td class="py-1">{{ !empty($user->attitude->religious_service) ? $user->attitude->religious_service : "" }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#residency-info">
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                ...
                                <div id="residency-info" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#spiritual-social">
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                ...
                                <div id="spiritual-social" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
                            ...
                            <!-- Life Style -->
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#life-style">
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                ...
                                <div id="life-style" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#astronomic">
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                ...
                                <div id="astronomic" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
                            ...
                            <!-- Permanent Address -->
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#permanent-address">
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24.659" height="19.623" viewBox="0 0 24.659 19.623" class="fill-primary-grad">
                                            <g transform="translate(-1078.67 -2909.649)">
                                                ...
                                                <path d="M114.439,263.248l-.948,1.132a.52.52,0,0,1-.321.168h-.046a.47.47,0,0,1-.321-.107l-10.584-8.825-10.584,8.825a.569.569,0,0,1-.367.107.52.52,0,0,1-.321-.168L90,263.248a.5.5,0,0,1-.107-.359.444.444,0,0,1,.168-.329l11-9.162a1.9,1.9,0,0,1,2.325,0l3.732,3.12v-2.983a.471.471,0,0,1,.489-.489h2.937a.471.471,0,0,1,.489.489v6.24l3.35,2.784a.444.444,0,0,1,.168.329A.5.5,0,0,1,114.439,263.248Z" transform="translate(988.781 2656.649)" class="fill-dark"/>
                                            </g>
                                        </svg>
                                    </span>
                                    <div class="ml-4">
                                ...
                                <div id="permanent-address" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    ...
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-sm-6 border-sm-left table-striped">
                                                <table class="w-100 ">
                                                    <tbody>
                                                        <tr>
                            ...
                            <!-- Family Information -->
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse" data-target="#family-info">
                                    <span class="size-50px border rounded-circle d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28.145" height="23.875" viewBox="0 0 28.145 23.875" class="fill-primary-grad">
                                            <g transform="translate(9.187 0)">
                                                ...
                                                <path d="M145.868,234.815h-4.976a4.067,4.067,0,0,0-4.063,4.063V247.1a.813.813,0,0,0,.813.813h11.477a.813.813,0,0,0,.813-.813v-8.226A4.067,4.067,0,0,0,145.868,234.815Z" transform="translate(-138.494 -224.042)" class="fill-dark"/>
                                                <path d="M172,38.84a4.885,4.885,0,1,0,4.886,4.886A4.892,4.892,0,0,0,172,38.84Z" transform="translate(-167.114 -38.84)" class="fill-dark"/>
                                            </g>
                                        </svg>
                                    </span>
                                    <div class="ml-4">
                                ...
                                <div id="family-info" class="accordion-body ml-3 ml-md-5 pl-25px" data-parent="#profile-accordion">
                                    <div class="border p-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <table class="w-100 table-striped">
