            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="diet" >
                        <option value="" disabled hidden @if($user_diet ==  '') selected @endif >{{translate('Select Yes/No')}}</option>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="drink" >
                        <option value="" disabled hidden @if($user_drink ==  '') selected @endif >{{translate('Select Yes/No')}}</option>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="smoke" >
                        <option value="" disabled hidden @if($user_smoke ==  '') selected @endif >{{translate('Select Yes/No')}}</option>
